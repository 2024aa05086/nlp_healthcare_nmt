...
helm.sh/chart: {{ include "healthcare-nmt.chart" . }}
{{ include "healthcare-nmt.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
{{- default (include "healthcare-nmt.fullname" .) .Values.serviceAccount.name }}
{{- else }}
